    ...
    try {
        ...
        const documentResult = await client.query(
            ...
            [
                ...
                customer.id, JSON.stringify(customerSnapshot(customer)), totals.productSubtotal,
    ...
    try {
        ...
        await client.query(
            `UPDATE documents SET
                ...
                payment_terms = $17,
                delivery_days = $18,
                quotation_validity_days = $19,
                updated_by = $20
             WHERE id = $21`,
            [
                body.document_date, body.due_date, customer.id,
                JSON.stringify(customerSnapshot(customer)), totals.productSubtotal,
                totals.serviceSubtotal, totals.otherSubtotal, totals.subtotal,
                totals.discount, totals.grandTotal, totals.withholdingRate,
                totals.withholdingBase, totals.withholdingAmount, totals.transferFee,
                totals.netTotal, body.remarks, body.payment_terms,
                body.delivery_days ?? null, body.quotation_validity_days ?? null,
                userId, id
            ]
        );
