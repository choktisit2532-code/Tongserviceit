...
const optionalHttpUrl = (label) => z
    ...
    }, { message: `${label} ต้องเป็น URL ที่ขึ้นต้นด้วย http:// หรือ https://` });

const optionalLogoSource = z
    ...
    }, { message: 'โลโก้ต้องเป็นไฟล์ PNG, JPG/JPEG, WebP ที่อัปโหลดจากระบบ หรือ URL แบบ http:// / https://' });
...
const settingsSchema = z.object({
    ...
    logo_url: optionalLogoSource,
    saved_signature_url: optionalHttpUrl('URL ลายเซ็น'),
